...
@Composable
fun LoginPage(modifier: Modifier, navHostController: NavHostController, onLoginComplete: () -> Unit,authViewModel: AuthViewModel) {
...
@Composable
fun SignupPage(modifier: Modifier, navHostController: NavHostController, onSignUpComplete: () -> Unit = {},viewModel: AuthViewModel) {
    var username by remember { mutableStateOf("") }
    var password by remember { mutableStateOf("") }
    var email by remember { mutableStateOf("") }
    var errorMessage by remember { mutableStateOf<String?>(null) }
        ...
        modifier = Modifier.fillMaxSize())
    {
        ...
        if(shouldNavigate){
            navHostController.navigate("verification/$email")
        }
