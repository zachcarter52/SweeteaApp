...
data class PriceData(
    ...
    val regular_high_formmated_with_modifiers: String,
    val regular_high_formmated_with_subscriptions: String,
    ...
    val regular_low_formmated_with_modifiers: String,
    val regular_low_formmated_with_subscriptions: String,
